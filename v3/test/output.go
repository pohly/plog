...
import (
	...
	"github.com/pohly/plog/v3/textlogger"
)
...
`,
	...
	"MarshalLog() for nil": {
		...
		expectedOutput: `I output.go:<LINE>] "marshaler nil" obj="<panic: value method github.com/pohly/plog/v3.ObjectRef.WriteText called using nil *ObjectRef pointer>"
`,
	},
	"Error() that panics": {
		text: "error panic",
