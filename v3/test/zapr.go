...
`,
		...
		`I output.go:<LINE>] "marshaler nil" obj="<panic: value method github.com/pohly/plog/v3.ObjectRef.WriteText called using nil *ObjectRef pointer>"
`: `{"caller":"test/output.go:<LINE>","msg":"marshaler nil","v":0,"objError":"PANIC=value method github.com/pohly/plog/v3.ObjectRef.MarshalLog called using nil *ObjectRef pointer"}
`,
