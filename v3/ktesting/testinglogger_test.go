...
import (
	...
	"github.com/pohly/plog/v3/internal/test/require"
...
func TestStop(t *testing.T) {
	...
	//        	github.com/pohly/plog/v3/internal/dbg.Stacks(0x0)
	//        		/nvme/gopath/src/k8s.io/klog/internal/dbg/dbg.go:34 +0x8a
	//        	github.com/pohly/plog/v3/ktesting.tlogger.fallbackLogger({0xc0000f2780, {0x0, 0x0}, {0x0, 0x0, 0x0}})
	//        		/nvme/gopath/src/k8s.io/klog/ktesting/testinglogger.go:292 +0x232
	//        	github.com/pohly/plog/v3/ktesting.tlogger.Info({0xc0000f2780, {0x0, 0x0}, {0x0, 0x0, 0x0}}, 0x0, {0x5444a5, 0x13}, {0x0, ...})
	...
	//        	github.com/pohly/plog/v3/ktesting_test.TestStop.func1.1()
	//        		/nvme/gopath/src/k8s.io/klog/ktesting/testinglogger_test.go:194 +0xe5
	//        	created by github.com/pohly/plog/v3/ktesting_test.TestStop.func1
