...
//   - [github.com/pohly/plog/v3/textlogger]: a logger which uses the same formatting as klog log with
//     simpler output routing; beware that it comes with its own command line flags
//     and does not use the ones from klog
//   - [github.com/pohly/plog/v3/ktesting]: per-test output in Go unit tests
//   - [github.com/pohly/plog/v3/klogr]: a deprecated, standalone [logr.Logger] on top of the main klog package;
//     use [Background] instead if klog output routing is needed, [github.com/pohly/plog/v3/textlogger] if not
//   - [github.com/pohly/plog/v3/examples]: demos of this functionality
//   - [github.com/pohly/plog/v3/test]: reusable tests for [logr.Logger] implementations
//
// Basic examples:
//
...
import (
	...
	"github.com/pohly/plog/v3/internal/buffer"
	"github.com/pohly/plog/v3/internal/clock"
	"github.com/pohly/plog/v3/internal/dbg"
	"github.com/pohly/plog/v3/internal/serialize"
	"github.com/pohly/plog/v3/internal/severity"
)
